...
{
    public class GA_COUNTER_TABLE_T1 : DBRecord
    {
        #region =====[Public] Class=====
        ...
        /// <summary>
        /// GA_COUNTER_TABLE_T1類別建構子
        /// </summary>
        public GA_COUNTER_TABLE_T1(IDbConnection pConn) : base(pConn)
        {
            try
            {
                m_sTableName = Properties.Settings.Default.TableName_GA_COUNTER_TABLE_T1;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// <summary>
        /// 篩選"GA_COUNTER_TABLE_T1"全部的資料庫表格記錄
        /// </summary>
        /// <param name="pSQLStr">SQL指令字串(SELECT)</param>
        /// <returns>"Counter Property Information"資料List</returns>
